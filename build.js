...
con.connect(function(err) {
  ...
  console.log("Connected!");
   ...
   con.query("CREATE DATABASE IF NOT EXISTS players_club", function (err, result) {
    ...
    var que = "CREATE TABLE IF NOT EXISTS athletes (name varchar(50), intro varchar(1028),school varchar(50), weight varchar(20), hometown varchar(20), class varchar(20), height varchar(20), interests varchar(112), sport varchar(50), positional_profile varchar(10), body varchar(112), hit varchar(224), power varchar(112), arm varchar(112), defense varchar(112), athletic_testing varchar(112))";
